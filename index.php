        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Nurdi DW</span>
            </a>
    ...
    <section class="sidebar">
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?page=data_mahasiswa"><i class="glyphicon glyphicon-education"></i> <span>Jadwal Kuliah</span></a></li>
          </ul>
          <ul class="treeview-menu">
            <li><a href="index.php?page=materi_kuliah"><i class="glyphicon glyphicon-book"></i> <span>Materi Kuliah</span></a></li>
          </ul>
      </li>
      <li>
          <a href="pages/calender/index.php">
